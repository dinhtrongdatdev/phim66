...
@push('header')
    <link rel='stylesheet' id='global-styles-inline-css' href='{{asset('themes/phim66/css/global-styles.css')}}?ver=1.0.0' type='text/css'/>
    <link rel='stylesheet' id='TOROFLIX_Theme-css' href='{{asset('themes/phim66/css/toroflix-public.css')}}?ver=1.0.0' type='text/css' media='all'/>
    <link rel='stylesheet' id='tp_style_css' href='{{asset('themes/phim66/css/tp_style.css')}}?ver=1.0.0' type='text/css' media='all'/>
@endpush

@section('body')
    <div class="Tf-Wp">
        @include("themes::themephim66.inc.header")
        <div class="Body">
            ...
            <div class="Main Container">
                ...
                <div class="TpRwCont ">
                    ...
                    @include('themes::themephim66.inc.rightbar')
                </div>
            </div>
        </div>
    </div>
...
@section('footer')
    ...
    <link rel='stylesheet' id='font-awesome-public_css-css'
          href='{{asset('themes/phim66/css/font-awesome.css')}}?ver=1.0.0'
          type='text/css' media='all'/>
    <link rel='stylesheet' id='material-public-css-css'
          href='{{asset('themes/phim66/css/material.css')}}?ver=1.0.0'
          type='text/css' media='all'/>
    ...
    <script type="text/javascript"
            src='{{asset('themes/phim66/js/jquery.js')}}?ver=3.0.0'
            id='funciones_public_jquery-js'></script>
    <script type="text/javascript"
            src='{{asset('themes/phim66/js/owl.carousel.min.js')}}?ver=1.0.0'
    ...
    <script type="text/javascript"
            src='{{asset('themes/phim66/js/sol.js')}}?ver=1.0.0'
            id='funciones_public_sol-js'></script>
    <script type="text/javascript"
            src='{{asset('themes/phim66/js/functions.js')}}?ver=1.0.0'
