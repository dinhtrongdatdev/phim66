...
@section('home_page_slider_poster')
    @if(count($home_page_slider_poster['data']))
        @include('themes::themephim66.inc.home_page_slider_poster')
    @endif
@endsection

@section('home_page_slider_thumb')
    @if(count($home_page_slider_thumb))
        @include('themes::themephim66.inc.home_page_slider_thumb')
    @endif
@endsection

@section('content')
    @foreach($data as $item)
        @include("themes::themephim66.inc.section." . $item["show_template"])
    @endforeach
@endsection
