                ...
                <div class="Info">
                    <div class="Vote">
                        <div class="post-ratings">
                            <img src="{{asset('themes/phim66/img/cnt/rating_on.gif')}}" alt="img"><span
...
@push('scripts')
    <script src="/themes/phim66/player/js/p2p-media-loader-core.min.js"></script>
    <script src="/themes/phim66/player/js/p2p-media-loader-hlsjs.min.js"></script>
            ...
            if (type == 'embed') {
                if (vastAds) {
                    ...
                    const objSetupFake = {
                        ...
                        aspectratio: "16:9",
                        width: "100%",
                        file: "/themes/phim66/player/1s_blank.mp4",
                        volume: 100,
                        mute: false,
                        autostart: true,
                        advertising: {
    ...
    <script src="/themes/phim66/plugins/jquery-raty/jquery.raty.js"></script>
    <link href="/themes/phim66/plugins/jquery-raty/jquery.raty.css" rel="stylesheet" type="text/css" />
    ...
    <script>
        ...
        $('#movies-rating-star').raty({
            ...
            starOff: '/themes/phim66/plugins/jquery-raty/images/star-off.png',
            starOn: '/themes/phim66/plugins/jquery-raty/images/star-on.png',
            starHalf: '/themes/phim66/plugins/jquery-raty/images/star-half.png',
