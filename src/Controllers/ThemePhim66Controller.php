...
namespace Ophim\ThemePhim66\Controllers;
...
class ThemePhim66Controller
{
    ...
    public function index(Request $request)
    {
        if ($request['search'] || $request['filter']) {
            ...
            return view('themes::ThemePhim66.catalog', [
                'data' => $data,
                'search' => $request['search'],
                'section_name' => "Tìm kiếm phim: $request->search"
            ]);
        }
        return view('themes::ThemePhim66.index', [
    ...
    public function getMovieOverview(Request $request)
    {
        ...
        return view('themes::ThemePhim66.single', [
            'currentMovie' => $movie,
    ...
    public function getEpisode(Request $request)
    {
        ...
        return view('themes::ThemePhim66.episode', [
            'currentMovie' => $movie,
            'movie_related' => $movie_related,
            'episode' => $episode,
