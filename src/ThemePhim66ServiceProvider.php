...
namespace Ophim\ThemePhim66;

use Illuminate\Foundation\Support\Providers\AuthServiceProvider as ServiceProvider;

class ThemePhim66ServiceProvider extends ServiceProvider
{
    ...
    public function boot()
    {
        ...
        $this->publishes([
            __DIR__ . '/../resources/assets' => public_path('themes/phim66')
        ], 'phim66-assets');
    }
    ...
    protected function setupDefaultThemeCustomizer()
    {
        config(['themes' => array_merge(config('themes', []), [
            'phim66' => [
                ...
                'package_name' => 'ophimcms/theme-phim66',
                'publishes' => ['phim66-assets'],
                'preview_image' => '',
                'options' => [
                    [
                        'name' => 'per_page_limit',
